#!/usr/bin/env python
#
# VISUALIZE WITH GLYPH 3D
#
# ./xyz2vtk.py Vconst_16_fem_bend_PIDX_10_pbc.frame_3.xyz 0.2 test.vti
#
...
if __name__ == "__main__":
    ...
    for xyz_coor in frame_xyz:
        X_real.append(xyz_coor[0] / epsx)
        Y_real.append(xyz_coor[1] / epsy)
        Z_real.append(xyz_coor[2] / epsz)
        radii_.append(0.2)
#        colors_.append()
